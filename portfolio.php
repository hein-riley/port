	...
	<div class="container-fluid main-body">
            ...
            <section class="section1">
                ...
                <div class="col-md-8 col-sm-12 col-xs-12 cont-col1">
                    ...
                    <p>
                        ...
                        <br><br>
                        Rizepoint was seeking a site redesign, as their active website was not acting to the capacity desired. Users weren't utilizing the tools the site provided. Potential customers weren't finding information about the product and they were leaving the site after only a short time.
                        <br><br>
        ...
        <section class="section3">  
            ...
            <div class="cont">
                ...
                <div class="cont">
                    <div class="col-md-6 col-sm-12 col-xs-12 cont-col2">
                        <h3>Winner of Marcom Gold Award for website redesign in 2017</h3>
                    </div><!--cont-col2-->
                </div><!--cont--> 
